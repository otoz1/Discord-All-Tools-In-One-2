...
def setTitle(_str):
    system = os.name
    if system == 'nt':
        ctypes.windll.kernel32.SetConsoleTitleW(f"{_str} - Made By otoz1 (credit to astraa)")
    elif system == 'posix':
        sys.stdout.write(f"\x1b]0;{_str} - Made By otoz1 (credit to astraa)\x07")
    else:
        pass
...
def discserver():
    print(f"""{y}------------------------------------------------------------------------------------------------------------------------\n {b}|{w} https://github.com/otoz1 {b}|{w} https://github.com/otoz1 {b}|{w} https://github.com/otoz1 {b}|{w} https://github.com/otoz1 {b}|{w} https://g\n{y}------------------------------------------------------------------------------------------------------------------------\n""")
